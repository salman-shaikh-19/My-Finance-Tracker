...
const ExpenseCategoryCountCard=({ 
  ...
  return (
    <div
      ...
      className="flex w-50 items-center bg-base-100  transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl flex-col gap-2 card shadow-lg rounded-lg "
    >
      <div
