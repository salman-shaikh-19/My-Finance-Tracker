...
const LiabilityForm=({handleSubmit,initialValues,isEdit = false})=>{
    ...
    return (
        <>
   <h1 className="text-center">{isEdit ? "Edit liability" : "Add liability"}</h1>
          <Formik
            ...
            validationSchema={Yup.object({
                ...
                startDate: Yup.date().required("Start date is required").max(new Date(), "Start date cannot be in the future"),
                endDate: Yup.date()
